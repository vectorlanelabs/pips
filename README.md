...
Eighteen games: **Farkle**, **Yahtzee**, **Tic Tac Toe**, **Hangman**, **Connect 4**,
**Rummy**, **Phase 10**, **Battleship**, **Dominoes**, **Wahoo**, **Checkers**,
**Mexican Train**, **Chess**, **Uno**, **Skip-Bo**, **Blackjack**, **Solitaire** (Klondike or FreeCell),
...
seats 2–4, Blackjack seats 2–6, Solitaire is one player, and Scrabble seats 2–4; the rest are two-player
(for now).
