...
**Mexican Train**, **Chess**, **Uno**, **Skip-Bo**, **Blackjack**, **Poker** (Texas Hold'em, Omaha, 5-Card Draw, or 7-Card Draw, with optional Deuces Wild and Ante house rules), **Solitaire** (Klondike or FreeCell),
...
seats 2–4, Blackjack seats 2–6, Poker seats 2–8 (Texas Hold'em and Omaha; 5-Card Draw seats 2–6, 7-Card Draw seats 2–5), Solitaire is one player, and Scrabble seats 2–4; the rest are two-player
(for now).
