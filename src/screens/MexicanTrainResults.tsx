...
import type { MTPublicState } from '../board-games/mexican-train/state'
import { useSound } from '../hooks/useSound'

// ---- Props ----

export interface MexicanTrainResultsProps {
...
export function MexicanTrainResults({
  localPlayerId,
  localName,
  names,
  colors,
  ...
  // Build ranked rows: every seated player by total pips, ASCENDING (lowest
  // pips wins — the only game like this).
  interface Row {
    id: string
    name: string
    color: string
          ...
          return (
            ...
            >
              ...
              <span style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 2 }}>
                <span style={{ fontSize: 13, fontWeight: 500, opacity: 0.85 }}>total pips</span>
                <span style={{ fontSize: 11, fontWeight: 600, opacity: 0.6 }}>13 rounds</span>
              </span>
