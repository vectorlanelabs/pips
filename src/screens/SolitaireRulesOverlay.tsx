...
const RULES: Record<SolitaireMode, { intro: string; bullets: string[] }> = {
  klondike: {
    ...
    bullets: [
      ...
      'Drag a card (or a face-up run) to move it, or just click it to send it straight to its foundation when that’s where it belongs. Cards can come back off a foundation if you need them.',
  ...
  freecell: {
    ...
    bullets: [
      ...
      'Drag a card (or a face-up run) to move it, or just click it to send it straight to its foundation when that’s where it belongs.',
