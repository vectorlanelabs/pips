...
export function Phase10RulesOverlay({ onClose }: { onClose: () => void }) {
  const bullets = [
    'Deck: 108 cards. 24 each of red, blue, green and yellow numbered 1–12, plus 4 Skip cards and 8 Wild cards.',
    ...
    'Your turn: draw from the stock, or take the top of the discard pile. A Skip can never be taken from the discard.',
    ...
    'A discarded Skip card skips the opponent’s next turn. There is no limit per round: repeated Skips against the same player keep stacking.',
