export function UnoRulesOverlay({ onClose }: { onClose: () => void }) {
  const bullets = [
    'Match the top discard by color, number, or type, or play a wild any time, even if you have another legal play. (This is a deliberate house rule: official Wild Draw Four rules restrict it to when you have no other play.) Skip, Reverse, and Draw Two hit the next player immediately; with two players, Reverse acts as a second Skip.',
