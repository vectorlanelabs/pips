...
export default function App() {
  ...
  if (!room && !rummyRole && !phase10Role && !battleshipRole && !dominoesRole && !wahooRole && !checkersRole && !mtRole && !chessRole && !unoRole && !skipBoRole && !solitaireOpen && !pyramidOpen) {
    return (
      <Landing
        name={name}
